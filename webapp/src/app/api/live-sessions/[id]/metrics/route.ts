...
import { isCookieAccount } from "@/lib/live-commands";
...
export async function GET(
  ...
  // Host mode cookie: metrik disetor WORKER HEADLESS (akurat via cookie host).
  // Panel cukup membaca snapshot terakhir yang sudah disimpan worker.
